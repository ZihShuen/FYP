...
#%%
#VGG16 /unable to run due to lack of GPU on personal computer system as vgg16 have 138mil parameters compared to resnet which has 11 mil 
torch.manual_seed(1)
model= vgg16(num_classes=3)
os.chdir(r"C:\Users\Admin\Documents\FYP\VGG16")
#model.cuda()
#training(model,lr1)
...
os.chdir(r"C:\Users\Admin\Documents\FYP\VGG16_BN")
#training(model,lr1)
